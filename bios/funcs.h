...
extern void* HeapReAlloc(void*, size_t);
extern void* HeapCAlloc(size_t, size_t);
extern size_t FormatTime(char*, size_t, const char*, const tm*);
extern tm* TimeToCalendar(const time_t*);
extern time_t CalendarToTime(tm*);
